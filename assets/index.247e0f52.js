 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bi(t){if(t.code!==x.FAILED_PRECONDITION||t.message!==_T)throw t;D("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cb(t){if(t.limitType==="L"&&t.explicitOrderBy.length===0)throw new N(x.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class ju{}function ni(t,...e){for(const n of e)t=n._apply(t);return t}class S$ extends ju{constructor(e,n,r){super(),this.fa=e,this.da=n,this._a=r,this.type="where"}_apply(e){const n=Ws(e.firestore),r=function(i,s,o,a,l,u,c){let h;if(l.isKeyField()){if(u==="array-contains"||u==="array-contains-any")throw new N(x.INVALID_ARGUMENT,`Invalid Query. You can't perform '${u}' queries on documentId().`);if(u==="in"||u==="not-in"){_1(c,u);const f=[];for(const p of c)f.push(w1(a,i,p));h={arrayValue:{values:f}}}else h=w1(a,i,c)}else u!=="in"&&u!=="not-in"&&u!=="array-contains-any"||_1(c,u),h=sb(o,s,c,u==="in"||u==="not-in");const d=yt.create(l,u,h);return function(f,p){if(p.ht()){const k=iv(f);if(k!==null&&!k.isEqual(p.field))throw new N(x.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${k.toString()}' and '${p.field.toString()}'`);const m=rv(f);m!==null&&mb(f,p.field,m)}const v=function(k,m){for(const y of k.filters)if(m.indexOf(y.op)>=0)return y.op;return null}(f,function(k){switch(k){case"!=":return["!=","not-in"];case"array-contains":return["array-contains","array-contains-any","not-in"];case"in":return["array-contains-any","in","not-in"];case"array-contains-any":return["array-contains","array-contains-any","in","not-in"];case"not-in":return["array-contains","array-contains-any","in","not-in","!="];default:return[]}}(p.op));if(v!==null)throw v===p.op?new N(x.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${p.op.toString()}' filter.`):new N(x.INVALID_ARGUMENT,`Invalid query. You cannot use '${p.op.toString()}' filters with '${v.toString()}' filters.`)}(i,d),d}(e._query,"where",n,e.firestore._databaseId,this.fa,this.da,this._a);return new Nt(e.firestore,e.converter,function(i,s){const o=i.filters.concat([s]);return new Kr(i.path,i.collectionGroup,i.explicitOrderBy.slice(),o,i.limit,i.limitType,i.startAt,i.endAt)}(e._query,r))}}function T$(t,e,n){const r=e,i=Hd("where",t);return new S$(i,r,n)}class x$ extends ju{constructor(e,n){super(),this.fa=e,this.wa=n,this.type="orderBy"}_apply(e){const n=function(r,i,s){if(r.startAt!==null)throw new N(x.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(r.endAt!==null)throw new N(x.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");const o=new Do(i,s);return function(a,l){if(rv(a)===null){const u=iv(a);u!==null&&mb(a,u,l.field)}}(r,o),o}(e._query,this.fa,this.wa);return new Nt(e.firestore,e.converter,function(r,i){const s=r.explicitOrderBy.concat([i]);return new Kr(r.path,r.collectionGroup,s,r.filters.slice(),r.limit,r.limitType,r.startAt,r.endAt)}(e._query,n))}}function b$(t,e="asc"){const n=e,r=Hd("orderBy",t);return new x$(r,n)}class hb extends ju{constructor(e,n,r){super(),this.type=e,this.ma=n,this.ga=r}_apply(e){return new Nt(e.firestore,e.converter,AT(e._query,this.ma,this.ga))}}function C$(t){return Yx("limit",t),new hb("limit",t,"F")}function A$(t){return Yx("limitToLast",t),new hb("limitToLast",t,"L")}class db extends ju{constructor(e,n,r){super(),this.type=e,this.ya=n,this.pa=r}_apply(e){const n=pb(e,this.type,this.ya,this.pa);return new Nt(e.firestore,e.converter,function(r,i){return new Kr(r.path,r.collectionGroup,r.explicitOrderBy.slice(),r.filters.slice(),r.limit,r.limitType,i,r.endAt)}(e._query,n))}}function R$(...t){return new db("startAt",t,!0)}function N$(...t){return new db("startAfter",t,!1)}class fb extends ju{constructor(e,n,r){super(),this.type=e,this.ya=n,this.pa=r}_apply(e){const n=pb(e,this.type,this.ya,this.pa);return new Nt(e.firestore,e.converter,function(r,i){return new Kr(r.path,r.collectionGroup,r.explicitOrderBy.slice(),r.filters.slice(),r.limit,r.limitType,r.startAt,i)}(e._query,n))}}function D$(...t){return new fb("endBefore",t,!1)}function P$(...t){return new fb("endAt",t,!0)}function pb(t,e,n,r){if(n[0]=q(n[0]),n[0]instanceof cu)return function(i,s,o,a,l){if(!a)throw new N(x.NOT_FOUND,`Can't use a DocumentSnapshot that doesn't exist for ${o}().`);const u=[];for(const c of Go(i))if(c.field.isKeyField())u.push(As(s,a.key));else{const h=a.data.field(c.field);if(nv(h))throw new N(x.INVALID_ARGUMENT,'Invalid query. You are trying to start or end a query using a document for which the field "'+c.field+'" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');if(h===null){const d=c.field.canonicalString();throw new N(x.INVALID_ARGUMENT,`Invalid query. You are trying to start or end a query using a document for which the field '${d}' (used as the orderBy) does not exist.`)}u.push(h)}return new Ri(u,l)}(t._query,t.firestore._databaseId,e,n[0]._document,r);{const i=Ws(t.firestore);return function(s,o,a,l,u,c){const h=s.explicitOrderBy;if(u.length>h.length)throw new N(x.INVALID_ARGUMENT,`Too many arguments provided to ${l}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);const d=[];for(let f=0;f<u.length;f++){const p=u[f];if(h[f].field.isKeyField()){if(typeof p!="string")throw new N(x.INVALID_ARGUMENT,`Invalid query. Expected a string for document ID in ${l}(), but got a ${typeof p}`);if(!sv(s)&&p.indexOf("/")!==-1)throw new N(x.INVALID_ARGUMENT,`Invalid query. When querying a collection and ordering by documentId(), the value passed to ${l}() must be a plain document ID, but '${p}' contains a slash.`);const v=s.path.child(ue.fromString(p));if(!F.isDocumentKey(v))throw new N(x.INVALID_ARGUMENT,`Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${l}() must result in a valid document path, but '${v}' is not because it contains an odd number of segments.`);const k=new F(v);d.push(As(o,k))}else{const v=sb(a,l,p);d.push(v)}}return new Ri(d,c)}(t._query,t.firestore._databaseId,i,e,n,r)}}function w1(t,e,n){if(typeof(n=q(n))=="string"){if(n==="")throw new N(x.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!sv(e)&&n.indexOf("/")!==-1)throw new N(x.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=e.path.child(ue.fromString(n));if(!F.isDocumentKey(r))throw new N(x.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return As(t,new F(r))}if(n instanceof Te)return As(t,n._key);throw new N(x.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Vd(n)}.`)}function _1(t,e){if(!Array.isArray(t)||t.length===0)throw new N(x.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);if(t.length>10)throw new N(x.INVALID_ARGUMENT,`Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`)}function mb(t,e,n){if(!n.isEqual(e))throw new N(x.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
